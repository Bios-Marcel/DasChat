...
public final class TrayNotification
{
  ...
  private static boolean isThereATray = false;
  @FXML
   ...
   */
  public TrayNotification( final String title, final String body, final Image img, final Paint rectangleFill )
  {
   ...
   */
  public TrayNotification( final String title, final String body, final NotificationType notificationType )
  {
  ...
  private void initTrayNotification( final String title, final String message, final NotificationType type )
  {

    try
    {
      final FXMLLoader fxmlLoader = new FXMLLoader( getClass().getResource( "/tray/views/TrayNotification.fxml" ) );
  ...
  public void setOnAction( final Runnable block )
  {
    rootNode.setOnMouseClicked( event ->
    {
      ...
      try
      {
        label = (LabeledText) event.getTarget();
    ...
    //    rectangleColor.setOnMouseClicked( event );
    //    lblMessage.setOnMouseClicked( event );
    //    lblTitle.setOnMouseClicked( event );
    //    rectangleColor.setOnMouseClicked( event );
  }

  public void setNotificationType( final NotificationType nType )
  {
  ...
  public void setTray( final String title, final String message, final NotificationType type )
  {
    setTitle( title );
    setMessage( message );
  ...
  public void setTray( final String title, final String message, final Image img, final Paint rectangleFill, final AnimationType animType )
  {
    setTitle( title );
    setMessage( message );
    setImage( img );
  ...
  public void setStylesheet( final String path )
  {
